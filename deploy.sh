...
#generate OSIS
python studybible_to_osis.py --title "The ESV Study Bible notes" --work_id "ESVN" esv --tag_level 0
python studybible_to_osis.py --title "The ESV Global Study Bible notes" --work_id "GLBN" global --tag_level 0
python studybible_to_osis.py --title "The McArthur Study Bible notes" --work_id "MCAN" mcarthur --tag_level 0
#exit 0
